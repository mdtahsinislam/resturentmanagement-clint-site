...
//this code is correct not change anything  i want any user click Purchase and <p className="text-md font-semibold mt-2">Purchase Count: {food.purchaseCount || 0}</p>the 0+1 increase